...
public class MessagerBridge {
    ...
    //Builders:
    public MessagerBridge(String db){
        DBName = db;
        startConnection();
    }

    public MessagerBridge(){}

    //Methods:
    public static void startConnection(){
        try{
            Class.forName("com.mysql.cj.jdbc.Driver");
            conn = DriverManager.getConnection("jdbc:mysql://localhost/" + DBName, "messager", "sOloQUedoUNAchisPADEluz");
